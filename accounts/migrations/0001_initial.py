    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notas', models.TextField(blank=True, null=True)),
                ('iva', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True)),
                ('tasa', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('direccion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='direccion_org', to='accounts.direccion')),
        ...
        migrations.AddField(
            ...
            name='org',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='organizacion', to='accounts.organizacion'),
        ),
        migrations.CreateModel(
            name='Persona',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objeto_impuesto', models.CharField(choices=[('01', 'No objeto de impuesto'), ('02', 'Sí objeto del impuesto'), ('03', 'Sí objeto del impuesto y no obligado al desglose'), ('04', 'Sí objeto del impuesto y no causa impuesto')], default='02', max_length=20, null=True)),
                ('subcontrato', models.BooleanField(default=False)),
                ('acreditado', models.BooleanField(default=True)),
                ('descuento', models.DecimalField(decimal_places=2, default=0, max_digits=10, null=True)),
